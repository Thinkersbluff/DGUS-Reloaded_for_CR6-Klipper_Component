...
I DO NOT HAVE A BTT SKR CR6 motherboard, and DO NOT KNOW WHAT PINs to substitute into this solution, so YOU will need to FIX microprobe.cfg, if you make the same conversion.  If you instead convert to a different sensor (e.g. BLTouch), you will need to develop your own custom .cfg file for the probe.
